...
//descriptions
    ...
    $robot_description = array('You are a heavy robot!', 'Dont you have a life?', 'You are reallly scary', 'You are the dumbest robot ever!!!');
...
//form validation
 ...
 if (  isset($_POST['name']) && !empty($_POST['name']) && strlen(trim($_POST['name'])) > 0 ) {
        ...
        echo "Please provide me with your name. In 5 seconds you'll be redirected to Step1!";
...
//mail to Eric================
    ...
    echo "<br>You haven't selected your creature type! In 5 seconds you'll be redirected to step1!";
    echo '<script type="text/javascript">    kickback();      </script>';
